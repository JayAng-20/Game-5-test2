import{At as e,B as t,Dt as n,G as r,R as i,Tt as a,W as o,dt as s,et as c,k as l,lt as u,mt as d,p as f,pt as p,rt as m,st as h,z as g}from"./three.module-CBYoKEBQ.js";var _=`
...
`;function A(e,t,n){e.wrapS=u,e.wrapT=u,e.colorSpace=t,e.anisotropy=n,e.generateMipmaps=!0,e.minFilter=g,e.magFilter=i}var j=class{renderer;scene=new p;camera=new c(-1,1,1,-1,0,1);quad;lastMs=0;constructor(e){this.renderer=e,this.quad=new o(new m(2,2),new r),this.quad.frustumCulled=!1,this.scene.add(this.quad)}pass(e,t){this.quad.material=e,this.renderer.setRenderTarget(t),this.renderer.render(this.scene,this.camera)}floatTarget(t){return new e(t,t,{type:l,format:h,minFilter:i,magFilter:i,wrapS:u,wrapT:u,generateMipmaps:!1,depthBuffer:!1,stencilBuffer:!1})}byteTarget(t,n){let r=new e(t,t,{type:a,format:h,generateMipmaps:!0,minFilter:g,magFilter:i,wrapS:u,wrapT:u,depthBuffer:!1,stencilBuffer:!1,colorSpace:n});return A(r.texture,n,this.renderer.capabilities.getMaxAnisotropy()),r}synthesise(e,r={}){let i=performance.now(),a=e.size,o=new n(1/a,1/a),c=r.seed??0,l=new n(37.13*c+11.7,19.71*c+5.3),u=new f(r.tint??16777215),p=this.renderer.getRenderTarget(),m=this.renderer.autoClear,h=this.renderer.toneMapping;this.renderer.toneMapping=0,this.renderer.autoClear=!1;let g=this.floatTarget(a),_=this.floatTarget(a),v=new d({vertexShader:x,fragmentShader:S(e.glsl),uniforms:{uSeed:{value:l},uTint:{value:u}},depthTest:!1,depthWrite:!1});this.pass(v,g);let y=new d({vertexShader:x,fragmentShader:C,uniforms:{tHeight:{value:null},uTexel:{value:o},uTalus:{value:.004},uRate:{value:.5}},depthTest:!1,depthWrite:!1});for(let t=0;t<(e.thermalPasses??0);t++)y.uniforms.tHeight.value=g.texture,this.pass(y,_),[g,_]=[_,g];let b=new d({vertexShader:x,fragmentShader:w,uniforms:{tHeight:{value:null},uTexel:{value:o},uRate:{value:.35}},depthTest:!1,depthWrite:!1});for(let t=0;t<(e.streakPasses??0);t++)b.uniforms.tHeight.value=g.texture,this.pass(b,_),[g,_]=[_,g];let E=g,A=this.byteTarget(a,t),j=new d({vertexShader:x,fragmentShader:T,uniforms:{tHeight:{value:E.texture},uTexel:{value:o},uStrength:{value:e.heightScale*a/8*(e.normalStrength??1)}},depthTest:!1,depthWrite:!1});this.pass(j,A);let M=()=>({tHeight:{value:E.texture},uTexel:{value:o},uAoStrength:{value:e.aoStrength??1},uHeightScale:{value:e.heightScale},uTileMetres:{value:e.tileMetres},uSeed:{value:l},uTint:{value:u}}),N=this.byteTarget(a,s),P=new d({vertexShader:x,fragmentShader:D(e.glsl),uniforms:M(),depthTest:!1,depthWrite:!1});this.pass(P,N);let F=this.byteTarget(a,t),I=new d({vertexShader:x,fragmentShader:O(e.glsl),uniforms:M(),depthTest:!1,depthWrite:!1});this.pass(I,F);let L=this.byteTarget(a,t),R=new d({vertexShader:x,fragmentShader:k,uniforms:{tHeight:{value:E.texture}},depthTest:!1,depthWrite:!1});this.pass(R,L),this.renderer.setRenderTarget(p),this.renderer.autoClear=m,this.renderer.toneMapping=h;for(let e of[v,y,b,j,P,I,R])e.dispose();g.dispose(),_.dispose(),this.lastMs=performance.now()-i;let z=[N,A,F,L];return{map:N.texture,normalMap:A.texture,ormMap:F.texture,heightMap:L.texture,size:a,heightScale:e.heightScale,dispose:()=>{for(let e of z)e.dispose()}}}dispose(){this.quad.geometry.dispose(),this.quad.material.dispose()}};function M(e){return Math.round(e*e*4*4*1.333)}var N=class{synth;sets=new Map;totalMs=0;constructor(e){this.synth=new j(e)}key(e,t){let n=t.tint===void 0?``:new f(t.tint).getHexString();return`${e}:${t.seed??0}:${n}`}get(e,t={}){let n=this.key(e,t),r=this.sets.get(n);if(r)return r;let i=y[e];if(!i)throw Error(`unknown texture recipe: ${String(e)}`);let a=this.synth.synthesise(i,t);return this.totalMs+=this.synth.lastMs,this.sets.set(n,a),a}static apply(e,t,n){e.map=t.map,e.normalMap=t.normalMap,e.roughnessMap=t.ormMap,e.metalnessMap=t.ormMap,e.aoMap=t.ormMap,e.aoMapIntensity=1,e.roughness=1,e.metalness=1,e.normalScale.set(1,1);for(let e of[t.map,t.normalMap,t.ormMap,t.heightMap])e.repeat.set(n,n);e.needsUpdate=!0}stats(){let e=0;for(let t of this.sets.values())e+=M(t.size);return{sets:this.sets.size,bytes:e,totalMs:this.totalMs,keys:[...this.sets.keys()]}}dispose(){for(let e of this.sets.values())e.dispose();this.sets.clear(),this.synth.dispose()}};export{b as n,y as r,N as t};